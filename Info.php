...
$sql="SELECT TransactionID,SenderID,RecID,Time,Balance FROM Transactions WHERE SenderId=$id or RecId=$id ";
//do the query and connect it with the database
$result =mysqli_query($connection,$sql);

$name="SELECT UserName FROM Users Where UserID=$id";
$myName=mysqli_query($connection,$name);

$sql2= "SELECT*FROM Users";
$result2 =mysqli_query($connection,$sql2);
$Users2=mysqli_fetch_all($result2,MYSQLI_ASSOC);

//fetching the resulting rows as an array

$Users=mysqli_fetch_all($result,MYSQLI_ASSOC);
$FinalName=mysqli_fetch_assoc($myName);

//best practice
//free result from memory
mysqli_free_result($result);
mysqli_free_result($myName);
//end connection
...
<?php if($Users): ?>
          <div class="details">
              <div class="recentCustomers">
                  <div class="cardHeader">
                      <h2><?php echo $FinalName['UserName'] ?>'s Transactions</h2>
                  </div>
        ...
        <?php else: ?>
                           ...
                           <i class="fa fa-exclamation-circle"></i>
                              ...
                              <div class="Contentt">
                                  <p>Sorry, but <?php echo $FinalName['UserName'] ?> Has no Transactions yet</p>
                              </div>
                           </div>
